    ...
    const formSubmit = async (e) => {
        ...
        if (terms) {
            ...
            await axios
                ...
                .then(() => {
                    toast.success(
                        "Now go to login by this account"
                    );
                    navigate("/login");
                })
                .catch((err) => {
            ...
            <Row className="flex-nowrap registeration_page">
                ...
                <Col className="registeration_side__col" >
                    <div className="registeration_form_side__header">
                        ...
                        <h1 className="registeration_form_side__header_h1">PATHFINDER-SC1 </h1>
                        <span className="registeration_form_side__header_span">
                            Already have account?
                            <Link to="/login" style={{ marginLeft: "5px", color: "#d3a42e" }}>
                                login
                            </Link>
                        </span>
                    </div>
                    {/* to make all the isnputs in form this form in the left center */}
                    <Form className="registeration_form_side__form" onSubmit= {formSubmit}>
