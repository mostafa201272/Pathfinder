            ...
            <Row className="flex-nowrap login_page">
                ...
                <Col className="login_form_side__col">
                    ...
                    <div className="login_form_side__header">
                        <span className="login_form_side__header_span">Login to</span>
                        <h1 className="login_form_side__header_h1">PATHFINDER-SC1</h1>
                        <span className="login_form_side__header_span">
                            You don't have an account
                            <Link to="/register" style={{ marginLeft: "5px", color: "#d3a42e" }}>
                                Create an account
                            </Link>
                        </span>
                    </div>
                    ...
                    <Form autoComplete="false" className="login_form_side__form" onSubmit={formSubmit}>
                        ...
                        <div className="d-flex justify-content-between my-4 align-items-center">
                            ...
                            <span className="d-flex my-3 align-items-center text-light keep_me_logged_in">
                                ...
                                <Form.Label htmlFor="loginSt" className="keep_me_logged_in_label">
                                    Keep me Logged in
                                </Form.Label>    
                            </span>
                        ...
                        <Link to="/ForgetPassword" className="login_form_side__form_forget_password">
                            Forgrt password
                        </Link>
                    ...
                    <div className="pathfinder_copy_rights">
                        <span>&copy;2022 all rights reserved. <span className="pathfinder_copy_rights__teamname">pathfinder team</span></span>
                    </div>
